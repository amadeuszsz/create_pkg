#!/usr/bin/env python3
#
# Copyright 2022 the Amadeusz Szymko
...
def find_and_replace(filename, pkg_name, email, description=None, maintainer=None):
    ...
    filedata = filedata.replace('MAINTAINER@EMAIL.XX', email)
